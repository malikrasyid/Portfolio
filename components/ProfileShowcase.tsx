...
export default function ProfileShowcase() {
  return (
    <div className="w-full py-20 flex flex-col md:flex-row gap-16 items-center">
      {/* Visual Element: Image with unique shape */}
      <div className="relative group w-48 h-48 md:w-56 md:h-56">
        <div className="absolute inset-0 bg-indigo-500 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform duration-500" />
        <div className="relative w-full h-full overflow-hidden rounded-2xl grayscale hover:grayscale-0 transition-all duration-700 border border-zinc-200">
          <img 
      ...
      <div className="flex-1 space-y-8 text-center md:text-left">
        <div className="space-y-2">
          <div className="flex items-center justify-center md:justify-start gap-2 text-indigo-600 font-black uppercase tracking-wider text-sm">
            <MapPin size={14} /> Jakarta, Indonesia
          </div>
          <h1 className="text-5xl md:text-6xl font-black tracking-tight text-zinc-900 leading-none">
            MALIK AL <span className="text-zinc-400">RASYIDI.</span>
          </h1>
          <p className="text-lg md:text-xl font-medium text-zinc-500 max-w-xl leading-snug">
